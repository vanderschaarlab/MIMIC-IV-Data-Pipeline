...
class BertEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.gender_embeddings = nn.Embedding(
            config.gender_vocab_size, config.hidden_size
        )
        self.ethnicity_embeddings = nn.Embedding(
            config.ethni_vocab_size, config.hidden_size
        )
...
class BertModel(Bert.modeling.BertPreTrainedModel):
    ...
    def forward(
        ...
        embedding_output = self.embeddings(
            input_ids, age_ids, gender_ids, ethni_ids, ins_ids, seg_ids, posi_ids
        )
...
class DataLoader(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return (
            ...
            torch.LongTensor(age),
            torch.LongTensor(gender),
            torch.LongTensor(ethni),
            torch.LongTensor(ins),
